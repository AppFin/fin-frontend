  ...
  finCore: {
    ...
    settings: {
      ...
      profile: {
        ...
        displayNameHelp: 'Como você quer ser chamado',
        gender: 'Gênero',
        birthDate: 'Data de Nascimento',
        imageUrl: 'URL da Foto de Perfil',
        genderOptions: {
          man: 'Masculino',
          woman: 'Feminino',
          other: 'Outro',
      ...
      appearance: {
        ...
        theme: 'Tema',
        currentTheme: 'Usando tema {{theme}} atualmente',
        lightTheme: 'claro',
        darkTheme: 'escuro',
      ...
      preferences: {
        ...
        comingSoon: 'Configurações adicionais em breve',
      },
      actions: {
        cancel: 'Cancelar',
        edit: 'Editar',
