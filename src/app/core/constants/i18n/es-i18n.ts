  ...
  finCore: {
    ...
    settings: {
      ...
      profile: {
        ...
        description: 'Actualice su información personal y administre su cuenta.',
        firstName: 'Nombre',
        lastName: 'Apellido',
        displayName: 'Nombre para Mostrar',
        displayNameHelp: 'Nombre que se mostrará a otros usuarios',
        gender: 'Género',
      ...
      appearance: {
        title: 'Apariencia',
        description: 'Personalice cómo se ve y se siente la aplicación.',
        theme: 'Tema',
      ...
      preferences: {
        title: 'Preferencias',
        description: 'Administre sus preferencias de notificaciones y comunicación.',
      ...
      messages: {
        ...
        unauthenticated: 'Debe iniciar sesión para acceder a la configuración',
      },
    },
    sharedComponents: {
      grid: {
