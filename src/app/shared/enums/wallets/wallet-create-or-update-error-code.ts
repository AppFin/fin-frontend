...
export const walletCreateOrUpdateErrorCodeMessages: ErrorMessagesMap<WalletCreateOrUpdateErrorCode> =
  new Map([
    [
      WalletCreateOrUpdateErrorCode.NameAlreadyInUse,
      { message: 'finCore.features.wallet.errors.nameAlreadyInUse' },
    ],
  ]);
