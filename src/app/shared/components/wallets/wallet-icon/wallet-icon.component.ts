...
export class WalletIconComponent {
  ...
  public readonly financialInstitutionItem = computed(() =>
    this.getFinancialInstitution(
      this.walletItem()?.financialInstitutionId ?? null
    )
  );
  ...
  private getFinancialInstitution(
    financialInstitutionId: string | null
  ): FinancialInstitutionOutput | undefined {
